...
func (_q *OperationLogQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *OperationLogQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *OperationLogQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *OperationLogQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *OperationLogQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *OperationLogQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OperationLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(operationlog.Table, operationlog.Columns, sqlgraph.NewFieldSpec(operationlog.FieldID, field.TypeUint64))
	_spec.From = _q.sql
